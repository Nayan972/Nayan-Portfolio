...
function Social() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_jw5o5z2', 'template_6rv3ytm', e.target, 'TCx8K148SBYYTLAWX')
      .then((result) => {
  ...
  return (
    <>
<section className="bg-zinc-900 text-gray-200 px-16  py-20 lg:py-[120px] overflow-hidden relative z-10">
   <div className="container">
      <div className="flex flex-wrap lg:justify-between -mx-4">
         <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div className="max-w-[570px] mb-12 lg:mb-0 pt-10">
               ...
               <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">(+91)8399074723</p>
                  </div>
               </div>
               <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">nathnayan972@gmail.com</p>
                  </div>
               </div>
            </div>
         </div>
         <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div className="bg-zinc-900 text-gray-200 relative rounded-lg p-8 sm:p-12 shadow-lg">
               <form onSubmit={sendEmail}>
                  ...
                  <div className="mb-6">
                     <input
                        ...
                        py-3
                        px-[14px]
                        text-body-color text-base border
                       bg-zinc-900
                        outline-none
                        focus-visible:shadow-none
                        focus:border-primary
